...
void Rim::setWidth(int w) { width = w; }

bool Rim::getAluminium() { return aluminium; }

void Rim::setAluminium(bool a) { aluminium = a; }

std::string Rim::getColor() { return color; }

void Rim::setColor(std::string c) { color = c; }

void Rim::show() {
  std::cout << "=========================Rim=============================\n";
  std::cout << "Name: " << this->getName() << std::endl;
  std::cout << "Aluminium: " << (this->getAluminium() ? "yes." : "no")
            << std::endl;
